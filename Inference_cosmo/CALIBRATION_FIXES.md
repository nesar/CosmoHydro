...
| 3 | KiDS k-range | `k_min: 0.05`, `k_max: 4.0` in the `kids` target | 0.03 / 7.0 | k=0.033, 0.050 bins carry ~48/~160 modes → 10–20% box sample noise (L=400 Mpc/h ⇒ k_f=0.0157); k_max=7 exceeds the aliasing-safe half mesh-Nyquist — ~6.3 for the actual 1600³ P(k) mesh (corrected 2026-09-17; this row previously assumed 1024³/~4.0). k_max=4.0 remains the conservative choice. |
