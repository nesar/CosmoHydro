...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{plot_summary_GSMF_7p_pk.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{plot_summary_GSMF_CGD_7p_pk.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{plot_summary_7p_GSMF_vs_GSMF_CGD_pk.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{plot_7p_vs_2cosmo_5subgrid_pk.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{plot_7p_vs_2cosmo_5subgrid_GSMF_CGD_pk.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{plot_summary_pk_cosmo_marg_vs_fixed.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{plot_summary_pk_cosmo_marg_vs_fixed_GSMF_CGD.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{plot_summary_pk_subgrid_marg_vs_fixed.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{plot_summary_pk_subgrid_marg_vs_fixed_GSMF_CGD.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{plot_7p_GSMF_vs_GSMF_CGD_pk.png}
